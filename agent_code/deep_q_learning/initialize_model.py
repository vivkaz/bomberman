...
model = tf.keras.models.Sequential([
    tf.keras.layers.Conv2D(30, 2, activation="elu", padding='same', input_shape=inputs_shape),
    tf.keras.layers.MaxPooling2D(2),
    tf.keras.layers.Conv2D(30, 2, activation="elu", padding='same'),
    tf.keras.layers.MaxPooling2D(2),
...
"feature_setup" : {"feature_function" : "fake_coin_field_bombs",
                   "INPUTS" : [3,inputs_shape]},

"train_method" : {"algo": "DQN","INPUTS" : [70] }
